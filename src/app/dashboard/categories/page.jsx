...
const Categories = () => {
  ...
  return (
    <div className='flex flex-col gap-6'>
      <div className='fixed  p-2 bg-gray-50 shadow-xl w-full z-30 flex flex-col-reverse md:flex-row items-start lg:items-center gap-6 '>
        ...
        <div className='flex items-center gap-2 border shadow-lg p-2 rounded-lg w-[80%] lg:w-[30%]'>
      ...
      <div className='p-10 z-0 pt-[35%] lg:pt-[10%]'>
