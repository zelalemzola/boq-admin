...
const Workers = () => {
  ...
  return (
    <div className=''>
        <div className="fixed bg-white z-30 w-full px-4 py-3 border-b shadow-md flex flex-col md:flex-row items-center gap-3 ">
        <Drawer>
          <DrawerTrigger>
        ...
        <div className="z-0 w-full pt-[30%] md:pt-[20%] lg:pt-[10%]  px-10 py-2">
